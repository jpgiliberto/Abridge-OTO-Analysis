...
SignalRaw1 <- read_csv("Raw Data DeID/Signal Data 12 22 to 12 25.csv") |> 
...
KeyUserHigh <- SessionsRaw |> 
  ...
  #12/20 median number of total usage was 105, top third was 150 will need to update
  mutate(HighUser = n>150) #|> 
  #select(-n)
...
ApptPerMoAIScribes <- LMAllNotes |> 
  filter(GroupData !="Control") |> 
  summarize(mean = median(Denominator))
